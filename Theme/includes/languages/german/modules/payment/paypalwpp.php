...
if (IS_ADMIN_FLAG === true) {
  ...
  '<font color="green"><hr /><strong>Voraussetzungen:</strong></font><br /><hr />*<strong>CURL</strong> wird für die Kommunikation mit dem Gateway genutzt und muss deshlb zwingend auf Ihrem Webspace vorhanden und aktiviert sein. (Falls Sie einen CURL Proxy verwenden, konfigurieren Sie diesen bitte unter Konfiguration -> Mein Shop)<br /><hr />');
}
...
define('MODULE_PAYMENT_PAYPAL_ENTRY_TRANSSTATE', 'Trans. Status:');
define('MODULE_PAYMENT_PAYPAL_ENTRY_AUTHCODE', 'Auth. Code:');
define('MODULE_PAYMENT_PAYPAL_ENTRY_AVSADDR', 'AVS Addressenübereinstimmung:');
define('MODULE_PAYMENT_PAYPAL_ENTRY_AVSZIP', 'AVS PLZ übereinstimmung:');
define('MODULE_PAYMENT_PAYPAL_ENTRY_CVV2MATCH', 'CVV2 übereinstimmung:');
define('MODULE_PAYMENT_PAYPAL_ENTRY_DAYSTOSETTLE', 'Tage bis zur Zahlung:');
